...
public class GemModel implements BakedModel {
  ...
  public GemModel(BakedModel original, ModelBakery loader) {
    ...
    this.itemHandler =
        new ItemOverrides(
            loader, missing, id -> missing, loader.getAtlasSet()::getSprite, List.of()) {
  ...
  public @NotNull List<BakedQuad> getQuads(
      BlockState pState, Direction pDirection, @NotNull RandomSource random) {
    return this.original.getQuads(pState, pDirection, random);
  }
