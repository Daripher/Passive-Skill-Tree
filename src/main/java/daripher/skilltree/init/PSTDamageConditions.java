...
public class PSTDamageConditions {
  ...
  public static final DeferredHolder<DamageCondition.Serializer, ? extends DamageCondition.Serializer> NONE =
      REGISTRY.register("none", NoneDamageCondition.Serializer::new);
  public static final DeferredHolder<DamageCondition.Serializer, ? extends DamageCondition.Serializer> PROJECTILE =
      REGISTRY.register("projectile", ProjectileDamageCondition.Serializer::new);
  public static final DeferredHolder<DamageCondition.Serializer, ? extends DamageCondition.Serializer> MELEE =
      REGISTRY.register("melee", MeleeDamageCondition.Serializer::new);
  public static final DeferredHolder<DamageCondition.Serializer, ? extends DamageCondition.Serializer> MAGIC =
      REGISTRY.register("magic", MagicDamageCondition.Serializer::new);
  public static final DeferredHolder<DamageCondition.Serializer, ? extends DamageCondition.Serializer> FALL =
      REGISTRY.register("fall", FallDamageCondition.Serializer::new);
  public static final DeferredHolder<DamageCondition.Serializer, ? extends DamageCondition.Serializer> FIRE =
      REGISTRY.register("fire", FireDamageCondition.Serializer::new);
  public static final DeferredHolder<DamageCondition.Serializer, ? extends DamageCondition.Serializer> POISON =
      REGISTRY.register("poison", PoisonDamageCondition.Serializer::new);
  public static final DeferredHolder<DamageCondition.Serializer, ? extends DamageCondition.Serializer> THORNS =
