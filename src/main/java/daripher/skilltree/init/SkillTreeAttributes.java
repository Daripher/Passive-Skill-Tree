...
public class SkillTreeAttributes {
	...
	public static final RegistryObject<Attribute> DAMAGE_WITH_POISONED_WEAPON = rangedAttribute("player", "damage_with_poisoned_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> PROJECTILE_DAMAGE_AGAINST_POISONED = rangedAttribute("player", "projectile_damage_against_poisoned", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> SPLASH_POTION_DAMAGE = rangedAttribute("player", "splash_potion_damage", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> DAMAGE_PER_ADAMITE_IN_WEAPON = rangedAttribute("player", "damage_per_adamite_in_weapon", 1D, 1D, 10D);
	...
	public static final RegistryObject<Attribute> ENCHANTED_SWORD_DAMAGE = rangedAttribute("player", "enchanted_sword_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> ENCHANTED_BOW_DAMAGE = rangedAttribute("player", "enchanted_bow_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> ENCHANTED_TRIDENT_DAMAGE = rangedAttribute("player", "enchanted_trident_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> ENCHANTED_CROSSBOW_DAMAGE = rangedAttribute("player", "enchanted_crossbow_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> ENCHANTED_AXE_DAMAGE = rangedAttribute("player", "enchanted_axe_damage", 1D, 1D, 2D);
	...
	public static final RegistryObject<Attribute> CRAFTED_MELEE_WEAPON_DAMAGE_BONUS = rangedAttribute("player", "crafted_melee_weapon_damage_bonus", 0D, 0D, 10D);
	public static final RegistryObject<Attribute> CRAFTED_MELEE_WEAPON_ATTACK_SPEED = rangedAttribute("player", "crafted_melee_weapon_attack_speed", 1D, 1D, 10D);
	...
	public static final RegistryObject<Attribute> MELEE_DAMAGE_WITH_SHIELD = rangedAttribute("player", "melee_damage_with_shield", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> PROJECTILE_DAMAGE_WITH_SHIELD = rangedAttribute("player", "projectile_damage_with_shield", 1D, 1D, 10D);
	// miner attributes
	...
	public static final RegistryObject<Attribute> GEM_POWER = rangedAttribute("player", "gem_power", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> GEM_POWER_IN_ARMOR = rangedAttribute("player", "gem_power_in_armor", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> GEM_POWER_IN_WEAPON = rangedAttribute("player", "gem_power_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> ARMOR_PER_GEM_IN_HELMET = rangedAttribute("player", "armor_per_gem_in_helmet", 0D, 0D, 10D);
	public static final RegistryObject<Attribute> DAMAGE_PER_GEM_IN_WEAPON = rangedAttribute("player", "damage_per_gem_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> ARMOR_PER_GEM_IN_CHESTPLATE = rangedAttribute("player", "armor_per_gem_in_chestplate", 0D, 0D, 10D);
	public static final RegistryObject<Attribute> MAXIMUM_LIFE_PER_GEM_IN_ARMOR = rangedAttribute("player", "maximum_life_per_gem_in_armor", 0D, 0D, 10D);
	public static final RegistryObject<Attribute> MAXIMUM_LIFE_PER_GEM_IN_HELMET = rangedAttribute("player", "maximum_life_per_gem_in_helmet", 0D, 0D, 10D);
	public static final RegistryObject<Attribute> ATTACK_SPEED_PER_GEM_IN_WEAPON = rangedAttribute("player", "attack_speed_per_gem_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> CRIT_CHANCE_PER_GEM_IN_WEAPON = rangedAttribute("player", "crit_chance_per_gem_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> CRIT_DAMAGE_PER_GEM_IN_WEAPON = rangedAttribute("player", "crit_damage_per_gem_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> LIFE_REGENERATION_PER_GEM_IN_HELMET = rangedAttribute("player", "life_regeneration_per_gem_in_helmet", 0D, 0D, 10D);
	public static final RegistryObject<Attribute> DAMAGE_WITH_GEM_IN_WEAPON = rangedAttribute("player", "damage_with_gem_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> ATTACK_SPEED_WITH_GEM_IN_WEAPON = rangedAttribute("player", "attack_speed_with_gem_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> DAMAGE_WITH_DIFFERENT_WEAPON_GEMS = rangedAttribute("player", "damage_with_different_weapon_gems", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> DAMAGE_WITH_SAME_WEAPON_GEMS = rangedAttribute("player", "damage_with_same_weapon_gems", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> MELEE_DAMAGE_PER_GEM_IN_WEAPON = rangedAttribute("player", "melee_damage_per_gem_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> PROJECTILE_DAMAGE_PER_GEM_IN_WEAPON = rangedAttribute("player", "projectile_damage_per_gem_in_weapon", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> DAMAGE_PER_IRISCITE_IN_WEAPON = rangedAttribute("player", "damage_per_iriscite_in_weapon", 1D, 1D, 10D);
	// hunter attributes
	...
	public static final RegistryObject<Attribute> PROJECTILE_DAMAGE = rangedAttribute("player", "projectile_damage", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> PROJECTILE_CRIT_DAMAGE = rangedAttribute("player", "projectile_crit_damage", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> CRAFTED_RANGED_WEAPON_ATTACK_SPEED = rangedAttribute("player", "crafted_ranged_weapon_attack_speed", 1D, 1D, 10D);
	public static final RegistryObject<Attribute> DAMAGE_PER_DISTANCE = rangedAttribute("player", "damage_per_distance", 1D, 1D, 2D);
	...
	public static final RegistryObject<Attribute> CRAFTED_RANGED_WEAPON_ADDITIONAL_SOCKETS = rangedAttribute("player", "crafted_ranged_weapon_additional_sockets", 0D, 0D, 1D);
	...
	public static final RegistryObject<Attribute> LIFE_PER_PROJECTILE_HIT = rangedAttribute("player", "life_per_arrow_hit", 0D, 0D, 50D);
	public static final RegistryObject<Attribute> ATTACK_SPEED_WITH_RANGED_WEAPON = rangedAttribute("player", "attack_speed_with_ranged_weapon", 1D, 1D, 10D);
	...
	public static final RegistryObject<Attribute> PROJECTILE_CRIT_CHANCE = rangedAttribute("player", "projectile_crit_chance", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> ARROW_DAMAGE = rangedAttribute("player", "arrow_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> TIPPED_ARROW_DAMAGE = rangedAttribute("player", "tipped_arrow_damage", 1D, 1D, 2D);
	// cook attriutes
	...
	public static final RegistryObject<Attribute> MELEE_DAMAGE_IF_NOT_HUNGRY = rangedAttribute("player", "melee_damage_if_not_hungry", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> PROJECTILE_DAMAGE_IF_NOT_HUNGRY = rangedAttribute("player", "projectile_damage_if_not_hungry", 1D, 1D, 2D);
	// shared attributes
	...
	// weapon attributes
	public static final RegistryObject<Attribute> BOW_DAMAGE = rangedAttribute("player", "bow_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> TRIDENT_DAMAGE = rangedAttribute("player", "trident_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> CROSSBOW_DAMAGE = rangedAttribute("player", "crossbow_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> AXE_DAMAGE = rangedAttribute("player", "axe_damage", 1D, 1D, 2D);
	public static final RegistryObject<Attribute> SWORD_DAMAGE = rangedAttribute("player", "sword_damage", 1D, 1D, 2D);
