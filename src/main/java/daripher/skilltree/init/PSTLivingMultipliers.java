...
public class PSTLivingMultipliers {
    ...
    public static final DeferredHolder<LivingMultiplier.Serializer, ? extends LivingMultiplier.Serializer> NONE = REGISTRY.register("none", NoneLivingMultiplier.Serializer::new);
    public static final DeferredHolder<LivingMultiplier.Serializer, ? extends LivingMultiplier.Serializer> NUMERIC_VALUE = REGISTRY.register("numeric_value", FloatFunctionMultiplier.Serializer::new);
