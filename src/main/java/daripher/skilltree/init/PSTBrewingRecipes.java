...
public class PSTBrewingRecipes {
    ...
    private static void addRecipe(RegisterBrewingRecipesEvent event, Potion inputPotion, Item ingredient, @NotNull Potion outputPotion) {
    ...
    private static void addRecipe(RegisterBrewingRecipesEvent event, Potion inputPotion, Item inputItem, Item ingredient, @NotNull Potion outputPotion, Item outputItem) {
    ...
    private static ItemStack getPotionStack(Item potionItem, @NotNull Potion outputPotion) {
        return PotionContents.createItemStack(potionItem, BuiltInRegistries.POTION.wrapAsHolder(outputPotion));
    }
}
