package daripher.skilltree.compat.ironsspellbooks.skill.bonus.function;
...
public class ManaLevelFunction implements FloatFunction<ManaLevelFunction> {
  private boolean percentage;
  private boolean missing;

  public ManaLevelFunction(boolean percentage, boolean missing) {
  ...
  public MutableComponent getConditionTooltip(SkillBonus.Target target, FloatFunctionEntityPredicate.Logic logic, Component bonusTooltip, float requiredValue) {
    ...
    Component logicDescription = logic.getTooltip("mana_level", valueDescription);
  ...
  public FloatFunction.Serializer getSerializer() {
    return IronsSpellbooksCompat.MANA_LEVEL_FUNCTION.get();
  }
  ...
  private void selectPercentageMode(
      Consumer<FloatFunction<?>> consumer, boolean percentage) {
  ...
  public static class Serializer implements FloatFunction.Serializer {
    ...
    public FloatFunction<?> deserialize(JsonObject json) throws JsonParseException {
      ...
      return new ManaLevelFunction(percentage, missing);
    }

    @Override
    public void serialize(JsonObject json, FloatFunction<?> provider) {
      if (!(provider instanceof ManaLevelFunction aProvider)) {
    ...
    public FloatFunction<?> createDefaultInstance() {
      return new ManaLevelFunction(false, false);
    }
  }
}
