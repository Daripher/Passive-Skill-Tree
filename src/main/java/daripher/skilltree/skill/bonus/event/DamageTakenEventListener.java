...
public class DamageTakenEventListener implements SkillEventListener {
  ...
  public boolean equals(Object o) {
    ...
    DamageTakenEventListener listener = (DamageTakenEventListener) o;
  ...
  public static class Serializer implements SkillEventListener.Serializer {
    ...
    public SkillEventListener deserialize(JsonObject json) throws JsonParseException {
      DamageTakenEventListener listener = new DamageTakenEventListener();
    ...
    public void serialize(JsonObject json, SkillEventListener listener) {
      if (!(listener instanceof DamageTakenEventListener aListener)) {
    ...
    public SkillEventListener createDefaultInstance() {
      return new DamageTakenEventListener();
    }
  }
}
