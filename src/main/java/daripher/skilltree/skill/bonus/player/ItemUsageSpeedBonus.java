...
public final class ItemUsageSpeedBonus implements SkillBonus<ItemUsageSpeedBonus> {
  ...
  public MutableComponent getTooltip() {
    ...
    tooltip = Component.translatable(getDescriptionId() + "." + keySuffix, itemCondition.getTooltip("plural"), multiplierString);
  ...
  private void selectPlayerCondition(SkillTreeEditor editor, Consumer<ItemUsageSpeedBonus> consumer, LivingCondition condition) {
  ...
  private void selectItemCondition(SkillTreeEditor editor, Consumer<ItemUsageSpeedBonus> consumer, ItemCondition condition) {
