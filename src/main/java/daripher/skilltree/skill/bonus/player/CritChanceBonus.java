...
public final class CritChanceBonus implements SkillBonus<CritChanceBonus> {
  ...
  public CritChanceBonus(float amount) {
    this.amount = amount;
  }
  ...
  @Override
  public SkillBonus<CritChanceBonus> copy() {
  ...
  public SkillBonus<CritChanceBonus> merge(SkillBonus<?> other) {
    ...
    CritChanceBonus mergedBonus = new CritChanceBonus(otherBonus.amount + this.amount);
