...
public class ModRussianTranslationProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		add(SkillTreeAttributes.ARMOR_PER_GEMSTONE_IN_HELMET.get(), "Броня за самоцвет в шлеме");
		add(SkillTreeAttributes.ARMOR_PER_GEMSTONE_IN_CHESTPLATE.get(), "Броня за самоцвет в нагруднике");
		add(SkillTreeAttributes.CRIT_CHANCE_PER_GEMSTONE_IN_WEAPON.get(), "Шанс критического удара за самоцвет в оружии");
