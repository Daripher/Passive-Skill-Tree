...
public class ModUsTranslationProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		addSkillBranch("hunter_offensive_crafting_", "Crafted Bow Speed", "+4% Charge Speed of Bows you Craft", 1, 6);
		addSkillBranch("hunter_defensive_crafting_", "Crafted Armor Evasion", "+1% Evasion from Armor you Craft", 1, 6);
		addSkillBranch("hunter_offensive_combat_", "Arrow Damage", "+1 Arrow Damage", 1, 5);
		addSkillBranch("hunter_defensive_combat_", "Evasion", "+1% Evasion", 1, 5);
		addSkillBranch("hunter_offensive_combat_", "Arrow Crit Damage", "+10% Arrow Crit Damage", 6, 10);
		addSkillBranch("hunter_defensive_combat_", "Movement Speed", "+2% Movement Speed", 6, 10);
		addSkill("hunter_offensive_notable_1", "Skillful Archer", "+25% Arrow Damage");
		...
		addSkill("hunter_offensive_keystone_1", "Eagle Eye", "+3% Damage for each Block between you and Enemy");
		addSkill("hunter_defensive_keystone_1", "Fitted Armor", "+1 Armor per Evasion chance");
		addSkill("hunter_crafting_notable_1", "Hatter", "Helmets you craft have an additional Gemstone slot");
		addSkillBranch("hunter_lesser_", "Double Loot chance", "+5% chance to Double loot from Monsters", 1, 5);
		...
		addSkillBranch("cook_offensive_crafting_", "Cooked Food Damage Bonus", "+1% Damage per Restoration point from Food you Cook", 1, 6);
		addSkillBranch("cook_defensive_crafting_", "Cooked Food Regeneration", "+0.1 Life Regeneration per Restoration point from Food you Cook", 1, 6);
		addSkillBranch("cook_offensive_combat_", "Axe Attack Speed", "+10% Attack Speed with Axes", 1, 5);
		addSkillBranch("cook_defensive_combat_", "Block Chance", "+1% Block Chance", 1, 5);
		addSkillBranch("cook_offensive_combat_", "Axe Crit Chance", "+10% Crit Chance with Axes", 6, 10);
		addSkillBranch("cook_defensive_combat_", "Maximum Life if ate Recently", "+1 Maximum Life if you ate Recently", 6, 10);
		...
		addSkill("cook_crafting_notable_1", "Delicacy", "+5% Crit Damage per Restoration point from Food you Cook");
		addSkillBranch("cook_lesser_", "Cooked Food Restoration", "+5% Restoration from Food you Cook", 1, 5);
		...
		addSkillBranch("alchemist_offensive_crafting_", "Harmful Potions Strength", "+5% Brewed Harmful Potions Strength", 1, 6);
		addSkillBranch("alchemist_defensive_crafting_", "Beneficial Potions Strength", "+5% Brewed Beneficial Potions Strength", 1, 6);
		addSkillBranch("alchemist_offensive_combat_", "Damage against Poisoned", "+20% Damage against Poisoned Enemies", 1, 5);
		addSkillBranch("alchemist_defensive_combat_", "Evasion under Potion Effect", "+2% Evasion under Potion Effect", 1, 5);
		addSkillBranch("alchemist_offensive_combat_", "Attack Speed under Potion Effect", "+3% Attack Speed under Potion Effect", 6, 10);
		addSkillBranch("alchemist_defensive_combat_", "Maximum Life under Potion Effect", "+2 Maximum Life under Potion Effect", 6, 10);
		...
		addSkill("alchemist_crafting_notable_1", "Purity", "+75% Brewed Potions Strength");
		addSkillBranch("alchemist_lesser_", "Brewed Potions Duration", "+10% Brewed Potions Duration", 1, 5);
		...
		addSkillBranch("enchanter_offensive_crafting_", "Weapon Enchantment Strenth", "+10% Weapon Enchantment Strenth", 1, 6);
		addSkillBranch("enchanter_defensive_crafting_", "Armor Enchantment Strenth", "+10% Armor Enchantment Strenth", 1, 6);
		addSkillBranch("enchanter_offensive_combat_", "Damage per Enchantment", "+1% Damage per Enchantment", 1, 5);
		addSkillBranch("enchanter_defensive_combat_", "Armor", "+1 Armor", 1, 5);
		addSkillBranch("enchanter_offensive_combat_", "Crit Chance per Enchantment", "+1% Crit Chance per Enchantment", 6, 10);
		addSkillBranch("enchanter_defensive_combat_", "Maximum Life with Enchtanted Item", "+2 Maximum Life if you have Enchanted Item Equipped", 6, 10);
		addSkill("enchanter_offensive_notable_1", "Embodiment of Power", "+10% Crit Damage per Enchantment");
		...
		addSkill("enchanter_offensive_keystone_1", "Excalibur", "+10% Damage per Enchantment Level on your Weapon");
		addSkill("enchanter_defensive_keystone_1", "Celestial Protection", "+2 Armor per Enchantment on your Chestplate");
		addSkill("enchanter_crafting_notable_1", "Runes", "+50% Enchantment Strength");
		addSkillBranch("enchanter_lesser_", "Level Requirement for Enchantments", "-5% Level Requirement for Enchantments", 1, 5);
		...
		addSkillBranch("blacksmith_offensive_crafting_", "Crafted Weapon Damage", "+1 Damage of Weapons you Craft", 1, 6);
		addSkillBranch("blacksmith_defensive_crafting_", "Crafted Armor Defense", "+10% Defence from Armor you Craft", 1, 6);
		addSkillBranch("blacksmith_offensive_combat_", "Damage with Shield", "+10% Damage while holding Shield", 1, 5);
		addSkillBranch("blacksmith_defensive_combat_", "Block Chance", "+1% Block Chance", 1, 5);
		addSkillBranch("blacksmith_offensive_combat_", "Crit Chance with Shield", "+10% Crit Chance while holding Shield", 6, 10);
		addSkillBranch("blacksmith_defensive_combat_", "Chestplate Defence", "+4% Armor from your Chestplate", 6, 10);
		addSkill("blacksmith_offensive_notable_1", "Impact", "+75% Crit Damage while holding Shield");
		...
		addSkill("blacksmith_crafting_notable_1", "Mystic Allow", "+25% Attack Speed of Weapons you Craft");
		addSkillBranch("blacksmith_lesser_", "Tougher Armor chance", "+10% chance to Craft Tougher Armor", 1, 5);
		...
		addSkillBranch("miner_offensive_crafting_", "Gemstone Strength in Weapon", "+10% Strength of Gemstones you insert into Weapon", 1, 6);
		addSkillBranch("miner_defensive_crafting_", "Gemstone Strength in Armor", "+10% Strength of Gemstones you insert into Armor", 1, 6);
		addSkillBranch("miner_offensive_combat_", "Pickaxe Damage", "+1 Pickaxe Damage", 1, 5);
		addSkillBranch("miner_defensive_combat_", "Armor", "+1 Armor", 1, 5);
		addSkillBranch("miner_offensive_combat_", "Pickaxe Attack Speed", "+10% Pickaxe Attack Speed", 6, 10);
		addSkillBranch("miner_defensive_combat_", "Movement Speed", "+2% Movement Speed", 6, 10);
		...
		addSkill("miner_crafting_notable_1", "Polishing", "+40% Strength of Gemstones you insert");
		addSkillBranch("miner_lesser_", "Mining Speed", "+5% Mining Speed", 1, 5);
