...
/**
 * Generic class for serialization and deserialization of key-value {@link Pair}
 * objects in JSON format.
 */
public class PairSerializer<K, V> implements JsonSerializer<Pair<K, V>>, JsonDeserializer<Pair<K, V>> {
