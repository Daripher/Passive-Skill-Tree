...
/**
 * Generic class to serialize and deserialize {@link Supplier} objects in JSON
 * format.
 */
public class SupplierSerializer<T> implements JsonSerializer<Supplier<T>>, JsonDeserializer<Supplier<T>> {
