...
public class PSTEnglishTranslationProvider extends PSTTranslationProvider {
  ...
  protected void addTranslations() {
    ...
    add(Tags.Items.TOOLS_SWORDS, "Sword");
    add(Tags.Items.TOOLS_SWORDS, "plural.type", "Swords");
    ...
    add(Tags.Items.TOOLS_AXES, "Axe");
    add(Tags.Items.TOOLS_AXES, "plural.type", "Axes");
    add(ItemTags.AXES, "plural", "Axes");
    add(Tags.Items.TOOLS_HOES, "Hoe");
    add(Tags.Items.TOOLS_HOES, "plural.type", "Hoes");
    add(ItemTags.HOES, "plural", "Hoes");
    add(Tags.Items.TOOLS_PICKAXES, "Pickaxe");
    add(Tags.Items.TOOLS_PICKAXES, "plural.type", "Pickaxes");
    add(ItemTags.PICKAXES, "plural", "Pickaxes");
    add(Tags.Items.TOOLS_SHOVELS, "Shovel");
    add(Tags.Items.TOOLS_SHOVELS, "plural.type", "Shovels");
