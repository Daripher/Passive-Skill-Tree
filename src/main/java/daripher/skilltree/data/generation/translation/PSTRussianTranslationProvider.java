...
public class PSTRussianTranslationProvider extends PSTTranslationProvider {
  ...
  protected void addTranslations() {
    ...
    add(PSTTags.WEAPONS, "Оружие");
    add(PSTTags.WEAPONS, "where", "Оружии");
    add(PSTTags.WEAPONS, "type", "ое Оружие");
    add(PSTTags.WEAPONS, "plural.type", "ое Оружие");
    add(PSTTags.WEAPONS, "plural", "Оружие");
    add(PSTTags.RANGED_WEAPONS, "Оружие дальнего боя");
    add(PSTTags.RANGED_WEAPONS, "where", "Оружии дальнего боя");
    add(PSTTags.RANGED_WEAPONS, "type", "ое Оружие дальнего боя");
    add(PSTTags.RANGED_WEAPONS, "plural.type", "ое Оружие дальнего боя");
    add(PSTTags.RANGED_WEAPONS, "plural", "Оружие дальнего боя");
    add(Tags.Items.TOOLS_BOWS, "Лук");
    add(Tags.Items.TOOLS_BOWS, "where", "Луке");
    add(Tags.Items.TOOLS_BOWS, "type", "ый Лук");
    add(Tags.Items.TOOLS_BOWS, "plural.type", "ые Луки");
    add(Tags.Items.TOOLS_BOWS, "plural", "Луки");
    add(Tags.Items.TOOLS_CROSSBOWS, "Арбалет");
    add(Tags.Items.TOOLS_CROSSBOWS, "where", "Арбалете");
    add(Tags.Items.TOOLS_CROSSBOWS, "type", "ый Арбалет");
    add(Tags.Items.TOOLS_CROSSBOWS, "plural.type", "ые Арбалеты");
    add(Tags.Items.TOOLS_CROSSBOWS, "plural", "Арбалеты");
    add(PSTTags.MELEE_WEAPONS, "Оружие ближнего боя");
    add(PSTTags.MELEE_WEAPONS, "where", "Оружии ближнего боя");
    add(PSTTags.MELEE_WEAPONS, "type", "ое Оружие ближнего боя");
    add(PSTTags.MELEE_WEAPONS, "plural.type", "ое Оружие ближнего боя");
    add(PSTTags.MELEE_WEAPONS, "plural", "Оружие ближнего боя");
    add(Tags.Items.TOOLS_SWORDS, "Меч");
    add(Tags.Items.TOOLS_SWORDS, "where", "Мече");
    add(Tags.Items.TOOLS_SWORDS, "type", "ый Меч");
    add(Tags.Items.TOOLS_SWORDS, "plural.type", "ые Мечи");
    add(ItemTags.SWORDS, "plural", "Мечи");
    add(Tags.Items.TOOLS_TRIDENTS, "Трезубец");
    add(Tags.Items.TOOLS_TRIDENTS, "where", "Трезубце");
    add(Tags.Items.TOOLS_TRIDENTS, "type", "ый Трезубец");
    add(Tags.Items.TOOLS_TRIDENTS, "plural.type", "ые Трезубцы");
    add(Tags.Items.TOOLS_TRIDENTS, "plural", "Трезубцы");
    ...
    add(Tags.Items.ARMORS, "Броня");
    add(Tags.Items.ARMORS, "where", "Броне");
    add(Tags.Items.ARMORS, "type", "ая Броня");
    add(Tags.Items.ARMORS, "plural.type", "ая Броня");
    add(Tags.Items.ARMORS, "plural", "Броня");
    add(Tags.Items.ARMORS_HELMETS, "Шлем");
    add(Tags.Items.ARMORS_HELMETS, "where", "Шлеме");
    add(Tags.Items.ARMORS_HELMETS, "type", "ый Шлем");
    add(Tags.Items.ARMORS_HELMETS, "plural.type", "ые Шлемы");
    add(Tags.Items.ARMORS_HELMETS, "plural", "Шлемы");
    add(Tags.Items.ARMORS_CHESTPLATES, "Нагрудник");
    add(Tags.Items.ARMORS_CHESTPLATES, "where", "Нагруднике");
    add(Tags.Items.ARMORS_CHESTPLATES, "type", "ый Нагрудник");
    add(Tags.Items.ARMORS_CHESTPLATES, "plural.type", "ые Нагрудники");
    add(Tags.Items.ARMORS_CHESTPLATES, "plural", "Нагрудники");
    add(Tags.Items.ARMORS_LEGGINGS, "Штаны");
    add(Tags.Items.ARMORS_LEGGINGS, "where", "Штанах");
    add(Tags.Items.ARMORS_LEGGINGS, "type", "ые Штаны");
    add(Tags.Items.ARMORS_LEGGINGS, "plural.type", "ые Штаны");
    add(Tags.Items.ARMORS_LEGGINGS, "plural", "Штаны");
    add(Tags.Items.ARMORS_BOOTS, "Ботинки");
    add(Tags.Items.ARMORS_BOOTS, "where", "Ботинках");
    add(Tags.Items.ARMORS_BOOTS, "type", "ые Ботинки");
    add(Tags.Items.ARMORS_BOOTS, "plural.type", "ые Ботинки");
    add(Tags.Items.ARMORS_BOOTS, "plural", "Ботинки");
    add(Tags.Items.TOOLS_SHIELDS, "Щит");
    add(Tags.Items.TOOLS_SHIELDS, "where", "Щите");
    add(Tags.Items.TOOLS_SHIELDS, "type", "ый Щит");
    add(Tags.Items.TOOLS_SHIELDS, "plural.type", "ые Щиты");
    add(Tags.Items.TOOLS_SHIELDS, "plural", "Щиты");
    add(PSTTags.EQUIPMENT, "Экипировка");
    add(PSTTags.EQUIPMENT, "where", "Экипировке");
    add(PSTTags.EQUIPMENT, "type", "ая Экипировка");
    add(PSTTags.EQUIPMENT, "plural.type", "ая Экипировка");
    add(PSTTags.EQUIPMENT, "plural", "Экипировка");
    ...
    add(Tags.Items.TOOLS, "Инструмент");
    add(Tags.Items.TOOLS, "where", "Инструменте");
    add(Tags.Items.TOOLS, "type", "ый Инструмент");
    add(Tags.Items.TOOLS, "plural.type", "ые Инструменты");
    add(Tags.Items.TOOLS, "plural", "Инструменты");
    add(Tags.Items.TOOLS_AXES, "Топор");
    add(Tags.Items.TOOLS_AXES, "where", "Топоре");
    add(Tags.Items.TOOLS_AXES, "type", "ый Топор");
    add(Tags.Items.TOOLS_AXES, "plural.type", "ые Топоры");
    add(ItemTags.AXES, "plural", "Топоры");
    add(Tags.Items.TOOLS_HOES, "Мотыга");
    add(Tags.Items.TOOLS_HOES, "where", "Мотыге");
    add(Tags.Items.TOOLS_HOES, "type", "ая Мотыга");
    add(Tags.Items.TOOLS_HOES, "plural.type", "ые Мотыги");
    add(ItemTags.HOES, "plural", "Мотыги");
    add(Tags.Items.TOOLS_PICKAXES, "Кирка");
    add(Tags.Items.TOOLS_PICKAXES, "where", "Кирке");
    add(Tags.Items.TOOLS_PICKAXES, "type", "ая Кирка");
    add(Tags.Items.TOOLS_PICKAXES, "plural.type", "ые Кирки");
    add(ItemTags.PICKAXES, "plural", "Кирки");
    add(Tags.Items.TOOLS_SHOVELS, "Лопата");
    add(Tags.Items.TOOLS_SHOVELS, "where", "Лопате");
    add(Tags.Items.TOOLS_SHOVELS, "type", "ая Лопата");
    add(Tags.Items.TOOLS_SHOVELS, "plural.type", "ые Лопаты");
    add(ItemTags.SHOVELS, "plural", "Лопаты");
