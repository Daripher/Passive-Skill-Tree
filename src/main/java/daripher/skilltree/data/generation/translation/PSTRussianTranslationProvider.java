...
public class PSTRussianTranslationProvider extends LanguageProvider {
  ...
  protected void addTranslations() {
    ...
    add(
        PSTAttributes.CRAFTED_RANGED_WEAPON_SOCKETS.get(),
        "Гнёзда создаваемого оружия дальнего боя");
    ...
    add(
        ...
        "Скорость атаки создаваемого оружия дальнего боя");
    ...
    add(
        PSTAttributes.ATTACK_SPEED_WITH_RANGED_WEAPON.get(),
        "Скорость атаки с оружием дальнего боя");
    ...
    add(
        PSTAttributes.MAXIMUM_LIFE_UNDER_POTION_EFFECT.get(),
        "Максимум здоровя под эффектом зелья");
    ...
    add(
        ...
        "Шанс создать усиленное благотворное зелье");
    add(
        PSTAttributes.BREWED_HARMFUL_POTIONS_STRENGTH.get(),
        "Шанс создать усиленное пагубное зелье");
    ...
    add(
        PSTAttributes.LIFE_PER_HIT_UNDER_POTION_EFFECT.get(),
        "Здоровье за удар под эффектом зелья");
    ...
    add(
        PSTAttributes.CRIT_CHANCE_PER_GEM_IN_WEAPON.get(),
        "Шанс критического удара за самоцвет в оружии");
    add(PSTAttributes.MINING_SPEED.get(), "Скорость добычи с киркой");
    add(
        PSTAttributes.MAXIMUM_LIFE_PER_GEM_IN_HELMET.get(),
        "Максимум здоровья за самоцвет в шлеме");
    ...
    add(
        ...
        "Регенерация здоровья за самоцвет в шлеме");
    ...
    add(
        PSTAttributes.CRAFTED_MELEE_WEAPON_DAMAGE_BONUS.get(),
        "Урон создаваемого оружия ближнего боя");
    add(
        PSTAttributes.CRAFTED_MELEE_WEAPON_ATTACK_SPEED.get(),
        "Скорость атаки создаваемого оружия ближнего боя");
    ...
    add(
        PSTAttributes.MAXIMUM_LIFE_WITH_ENCHANTED_ITEM.get(),
        "Максимум здоровья с зачарованным предметом");
    add(
        PSTAttributes.MAXIMUM_LIFE_PER_ARMOR_ENCHANTMENT.get(),
        "Максимум здоровья за каждое зачарование брони");
    add(
        PSTAttributes.ATTACK_SPEED_WITH_ENCHANTED_WEAPON.get(),
        "Скорость атаки с зачарованным оружием");
    ...
    add(
        ...
        "Шанс критического удара с зачарованным оружием");
    add(
        PSTAttributes.CRIT_DAMAGE_PER_WEAPON_ENCHANTMENT.get(),
        "Критический урон за каждое зачарование на оружии");
    add(
        PSTAttributes.LIFE_ON_BLOCK_PER_SHIELD_ENCHANTMENT.get(),
        "Здоровье при блоке за каждое зачарование на щите");
    add(
        PSTAttributes.BLOCK_CHANCE_PER_SHIELD_ENCHANTMENT.get(),
        "Шанс блока за каждое зачарование на щите");
    add(
        PSTAttributes.DAMAGE_PER_WEAPON_ENCHANTMENT_LEVEL.get(),
        "Урон за уровень зачарования на оружии");
    ...
    add(
        ...
        "Лечение создаваемой еды за единицу насыщения");
    add(
        PSTAttributes.COOKED_FOOD_DAMAGE_PER_SATURATION.get(),
        "Урон создаваемой еды за единицу насыщения");
    ...
    add(
        PSTAttributes.CRIT_CHANCE_IF_NOT_HUNGRY.get(),
        "Шанс критического удара если вы не голодны");
    ...
    add(
        ...
        "Максимум здоровья за единицу утолённого голода");
    ...
    add(
        ...
        "Шанс блока за единицу утолённого голода");
    ...
    add(
        ...
        "Критический урон создаваемой еды за единицу насыщения");
    add(
        PSTAttributes.CRIT_DAMAGE_PER_SATISFIED_HUNGER.get(),
        "Критический урон за единицу утолённого голода");
    ...
    add(
        PSTAttributes.ATTACK_SPEED_WITH_GEM_IN_WEAPON.get(),
        "Скорость атаки с самоцветом в оружии");
    ...
    add(
        PSTAttributes.BREWED_HEALING_POTIONS_STRENGTH.get(),
        "Шанс создать усиленное лечебное зелье");
    add(
        PSTAttributes.BREWED_HARMFUL_POTIONS_DURATION.get(),
        "Длительность создаваемых пагубных зелий");
    add(
        PSTAttributes.BREWED_BENEFICIAL_POTIONS_DURATION.get(),
        "Длительность создаваемых благотворных зелий");
    ...
    add(
        PSTAttributes.MAXIMUM_LIFE_PER_EQUIPPED_JEWELRY.get(),
        "Максимальное здоровье за надетую бижутерию");
    add(PSTAttributes.CRAFTED_RINGS_CRITICAL_DAMAGE.get(), "Критический урон создаваемых колец");
    add(
        PSTAttributes.CRAFTED_NECKLACES_MAXIMUM_LIFE.get(),
        "Максимальное здоровье создаваемых ожерелий");
    ...
    add(
        PSTAttributes.CRAFTED_AXES_CRIT_CHANCE.get(),
        "Шанс критического удара создаваемых топоров");
    ...
    add(
        PSTAttributes.CRAFTED_BOOTS_MOVEMENT_SPEED.get(),
        "Скорость передвижения создаваемых ботинок");
    add(
    ...
    add(
        PSTAttributes.CRAFTED_SHIELDS_MAXIMUM_LIFE.get(),
        "Максимальное здоровье создаваемых щитов");
    ...
    add(
        ...
        "Шанс критического удара по горящим врагам");
    ...
    add(
        ...
        "Урон по горящим врагам создаваемых колчанов");
    add(
        PSTAttributes.MAXIMUM_LIFE_PER_ARROW_IN_QUIVER.get(),
        "Максимальное здоровье за стрелу в колчане");
    add(PSTAttributes.CRAFTED_QUIVERS_CAPACITY.get(), "Вместимость создаваемых колчанов");
    add(
        PSTAttributes.CRAFTED_QUIVERS_MAXIMUM_LIFE.get(),
        "Максимальное здоровье создаваемых колчанов");
    ...
    add(
        ...
        "Шанс критического удара создаваемого оружия ближнего боя");
    add(
        PSTAttributes.CRAFTED_WEAPON_DOUBLE_LOOT_CHANCE.get(),
        "Шанс удвоенной добычи создаваемого оружия");
    ...
    add(
        ...
        "Урон по горящим врагам создаваемого оружия");
    ...
    add(
        ...
        "Шанс вернуть стрелы создаваемых колчанов");
