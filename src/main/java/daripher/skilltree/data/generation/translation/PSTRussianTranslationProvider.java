...
public class PSTRussianTranslationProvider extends PSTTranslationProvider {
  ...
  protected void addTranslations() {
    ...
    add(ItemTags.SWORDS, "Меч");
    add(ItemTags.SWORDS, "where", "Мече");
    add(ItemTags.SWORDS, "type", "ый Меч");
    add(ItemTags.SWORDS, "plural.type", "ые Мечи");
    ...
    add(ItemTags.AXES, "Топор");
    add(ItemTags.AXES, "where", "Топоре");
    add(ItemTags.AXES, "type", "ый Топор");
    add(ItemTags.AXES, "plural.type", "ые Топоры");
    add(ItemTags.AXES, "plural", "Топоры");
    add(ItemTags.HOES, "Мотыга");
    add(ItemTags.HOES, "where", "Мотыге");
    add(ItemTags.HOES, "type", "ая Мотыга");
    add(ItemTags.HOES, "plural.type", "ые Мотыги");
    add(ItemTags.HOES, "plural", "Мотыги");
    add(ItemTags.PICKAXES, "Кирка");
    add(ItemTags.PICKAXES, "where", "Кирке");
    add(ItemTags.PICKAXES, "type", "ая Кирка");
    add(ItemTags.PICKAXES, "plural.type", "ые Кирки");
    add(ItemTags.PICKAXES, "plural", "Кирки");
    add(ItemTags.SHOVELS, "Лопата");
    add(ItemTags.SHOVELS, "where", "Лопате");
    add(ItemTags.SHOVELS, "type", "ая Лопата");
    add(ItemTags.SHOVELS, "plural.type", "ые Лопаты");
