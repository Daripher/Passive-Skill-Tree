...
public class GridSettingsEditor extends EditorMenu {
  ...
  public void init() {
    ...
    editor.increaseHeight(19);
    editor.addCheckBox(0,0, skillDragger.isGridSnapEnabled())
            .setResponder(skillDragger::setGridSnapEnabled);
    editor.addCheckBox(100,0, skillDragger.isShowGrid())
            .setResponder(skillDragger::setShowGrid);
    editor.increaseHeight(19);
  }
}
