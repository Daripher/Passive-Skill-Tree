...
public class TextureSelectionMenuButton extends SelectionMenuButton<ResourceLocation> {
  ...
  public TextureSelectionMenuButton(
    ...
    this.selectionList =
        new TextureSelectionList(0, 0, 19, 19, 16, 16, values).setColumns(10).setRows(10);
  }
  ...
  protected void selectMenu(SkillTreeEditor editor) {
    TextureSelectionMenu menu =
        new TextureSelectionMenu(
                editor,
                editor.getSelectedMenu(),
                (TextureSelectionList) selectionList,
                texturesFolder,
                onMenuInit)
            .setSelectionListGridSize(selectionListRows, selectionListColumns)
