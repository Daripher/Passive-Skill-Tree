...
public enum QuiverHud implements IGuiOverlay {
	...
	private void renderSlot(int x, int y, float partialTick, Player player, ItemStack stack, int i, int count) {
		...
		itemRenderer.renderAndDecorateItem(player, stack, x, y, i);
